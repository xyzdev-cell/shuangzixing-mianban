    ...
    constructor() {
        ...
        this.translations = {
            zh: {
                ...
                'keepalive_description': '启用后将在模型列表中显示带(pseudo-stream)标签的伪流式模型',
                'max_retry_setting': '最大重试次数',
                'max_retry_description': 'API请求失败时的最大重试次数（默认：3）',
                'retry_status_codes_setting': '可重试错误状态码',
                'retry_status_codes_description': '逗号分隔 HTTP 状态码（默认：503）',
                'web_search_setting': '联网搜索',
                'web_search_description': '启用后将在模型列表中显示带(search)标签的联网搜索模型',
             ...
             en: {
                ...
                'keepalive_description': 'Enable to show models tagged with (pseudo-stream) for one-shot pseudo streaming',
                'max_retry_setting': 'Max Retry Count',
                'max_retry_description': 'Maximum retry attempts for failed API requests (default: 3)',
                'retry_status_codes_setting': 'Retryable HTTP status codes',
                'retry_status_codes_description': 'Comma-separated HTTP status codes (default: 503)',
                'web_search_setting': 'Web Search',
                'web_search_description': 'Enable to show models tagged with (search) for web search functionality',
